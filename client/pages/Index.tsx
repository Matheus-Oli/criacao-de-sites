              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Matheus Oliveira é um desenvolvedor especializado em
                    soluções completas de desenvolvimento web, oferecendo
                    serviços de criação, otimização, manutenção e modernização
                    para ambientes digitais e comerciais.
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-3xl p-8 text-center hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Tecnologia de qualidade com preços acessíveis. Sem taxas
                  ocultas ou surpresas no orçamento.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <p className="text-gray-600 text-sm">
                  Domínio avançado em TypeScript para desenvolvimento type-safe
                  e código mais robusto.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <p className="text-gray-600 text-sm">
                  Certificação em análise de dados web e otimização de
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <p className="text-gray-600 text-sm">
                  Metodologias ágeis para gestão eficiente de projetos e
                  entregas no prazo.
                </p>
              </div>
            </div>
